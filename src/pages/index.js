...
import GirlImage from "../images/sisa-profile.jpg"
    ...
    <Container>
      ...
      <MainRow>
        <div className={styles.quotation}>
          „Láska k peniazom nie je koreňom všetkého zla. Nedostatok peňazí je
          koreňom všetkého zla.“ <br /> Robert Kiyosaki
        </div>
      </MainRow>
      <div className={styles.icons}>
        <a
          href="https://telegram.me/SisaKollarikova"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/sisakollarikova/"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.media}
        >
        ...
        <a
          href="//api.whatsapp.com/send?phone=421902835544"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.media}
        >
        ...
        <a
          href="mailto:simonka2692@gmail.com"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.media}
        >
